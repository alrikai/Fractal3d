/* oclfractal_main.cpp -- part of the fractal3d implementation 
 *
...
#include "fractal_gen/ocl_fractals/oclfractal_generator.hpp"
...
int main()
{
  ...
  using fractal_backend_t = fractal_generator<oclFractals, fpoint_t, pixel_t>;
